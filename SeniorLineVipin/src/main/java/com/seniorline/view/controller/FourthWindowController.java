...
public class FourthWindowController implements Initializable, ControllerI {
	...
	private static final Logger logger = Logger.getLogger(FourthWindowController.class.getName());
...
//									Image image = SeniorLineDao.parsebase64StringToImage(contactDeatils.getImage());
...
//		changeScreenAuto();
	...
	public void handleActionControl(String control) {
		this.mainController.loadScreen(ScreenConstant.ScreenLinks.FIFTH_WINDOW);
	}
					...
					public void initScreen(final String screenUri) {
						Platform.runLater(new Runnable() {
							public void run() {
								...
								System.out.println("changeScreenAuto() Fifth");
							}
						});
					}
				}, ScreenConstant.ScreenLinks.FIFTH_WINDOW);
