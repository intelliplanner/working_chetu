...
public class ScreenConstant {
	...
	public static final String BASE = "/com/seniorline/view/ui/account/";// com.ipssi.ppgcl.ui.view
//	public static final String IMAGE_BASE = "/images/";
	public static final String CAPTURE_IMAGE_BASE = "D:\\";
	public static final String IMAGE_BASE = "/com/seniorline/images/";
	public static final String STYLE_BASE = "/com/seniorline/css/";
...
//		public static final String APPLICATION_ICON = IMAGE_BASE + "logo_seniorline.png";
	...
	public static class ScreenLinks {
		...
		public static final String FIFTH_WINDOW = BASE + "FifthWindow_Old.fxml";
		public static final String SIXTH_WINDOW = BASE + "SixthWindow.fxml";
		public static final String SEVEN_WINDOW = BASE + "SevenWindow.fxml";
